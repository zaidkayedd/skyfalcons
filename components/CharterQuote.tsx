 ...
 * Trip Details (Trip Type / Passengers / Aircraft Category) with an
 * "Additional Information" step that reveals route, dates and contact fields.
 */
    ...
    <div className="rounded-card border border-mist/70 bg-white p-7 shadow-card sm:p-9">
      ...
      <div
        className={`grid transition-all duration-500 ease-premium ${
          showMore ? "mt-6 grid-rows-[1fr] opacity-100" : "grid-rows-[0fr] opacity-0"
        }`}
      >
      ...
      >
        {showMore ? "Request Quote" : "Additional Information"}
