  ...
  return (
    <header
      className={cn(
        ...
        solid
          ? "bg-porcelain/90 backdrop-blur-md border-b border-mist"
          : "bg-transparent"
      )}
    >
      <nav className="mx-auto flex h-[72px] max-w-content items-center justify-between px-5 sm:px-8">
        <Link
          href="/"
      ...
      <div
        className={cn(
          "md:hidden overflow-hidden bg-porcelain transition-[max-height] duration-500 ease-premium",
